...
<header class=\"topbar\"><div><p class=\"lab-mark\">PTL SCIENCE LAB</p><h1>교실 환경 탐구</h1><p class=\"subtitle\">CO₂와 온·습도의 변화를 실시간으로 관찰합니다.</p></div><div class=\"header-side\"><div class=\"device-clock\"><span>DEVICE TIME</span><strong id=\"device-time\">%s</strong></div><span id=\"sensing-badge\" class=\"badge %s\">%s</span></div></header>
<section class=\"status-panel\"><div class=\"experiment-state\"><span class=\"overline\">EXPERIMENT STATUS</span><strong>%s</strong></div><div class=\"quick-stats\"><div class=\"quick-item\"><span>표본</span><strong id=\"sample-count\">%d회</strong></div><div class=\"quick-item\"><span>데이터</span><strong id=\"data-freshness\">%s</strong></div><div class=\"quick-item\"><span>시간</span><strong id=\"time-state\">%s</strong></div></div></section>
...
</div></section><div class=\"meta\"><span>데이터 <b id=\"meta-freshness\">%s</b></span><span>시간 <b id=\"meta-time-state\">%s</b></span><span>저장 대기 <b id=\"pending-count\">%d</b>건</span><span>누락 <b id=\"dropped-count\">%d</b>건</span></div>
</main><script>
