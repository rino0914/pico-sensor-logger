...
Pico W가 비밀번호 없는 개방형 Wi-Fi 액세스 포인트와 웹 서버를 실행합니다. 학생은 스마트폰으로 Pico W에 접속해 실시간 측정값과 그래프를 확인하고, 측정을 제어하거나 CSV 파일을 내려받을 수 있습니다.
...
Wi-Fi 액세스 포인트는 비밀번호 없이 개방형으로 동작합니다. 주변 사용자는 누구나 접속하고 측정을 제어할 수 있으므로 통제된 실험 환경에서 사용해야 합니다. CSV 필드 이름과 순서는 위 예시와 동일해야 합니다.
